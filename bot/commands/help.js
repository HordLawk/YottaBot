    ...
    execute: async (message, args) => {
        ...
        if(!args.length){
            ...
            embed = new MessageEmbed()
                ...
                .setAuthor(channelLanguage.get('helpEmbedTitle'), message.client.user.avatarURL({
                    size: 4096,
                    dynamic: true,
                }))
        ...
        embed = new MessageEmbed()
            .setColor(message.guild ? (message.guild.me.displayColor || 0x8000ff) : 0x8000ff)
            .setAuthor(channelLanguage.get('helpCommandEmbedTitle', [command.name]), message.client.user.avatarURL({
                size: 4096,
                dynamic: true,
            }))
            .setDescription(command.description(channelLanguage))
            .setFooter(channelLanguage.get('helpCommandEmbedFooter'))
            .setTimestamp();
