...
module.exports = {
    ...
    example: ['enable on', 'stack off', 'roles add @Active 1440', 'roles remove @Active', 'user add 100 @LordHawk#0001', 'ignore role remove @Mods', 'ignore channel add #spam', 'notify #levelup', 'recommend 16 43368'],
    cooldown: 5,
    categoryID: 4,
    args: true,
