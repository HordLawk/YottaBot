...
Permissions.ALL-Permissions.FLAGS.STREAM
...
app.get('*', (req, res) => res.redirect(`https://discord.com/api/oauth2/authorize?client_id=371902120561082368&permissions=${Permissions.ALL}&scope=bot+applications.commands`));
